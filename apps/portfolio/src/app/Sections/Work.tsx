  ...
  const works = useMemo<WorkCardProps[]>(() => [
    {
      ...
      description: 'Mentor.AI is a platform leveraging AI to provide customized roadmaps laveraging LLMs. I worked as a Data Scientist focusing on building an efficient RAG system.',
      focusPoints: [
    ...
    },
    {
      ...
      description: 'Safandi.com is a healthcare startup aiming to automate the process of detecting destructive behaviour (ex. bullying, gaslighting, etc.) between couples. I worked on the backend and data analysis of the project.',
      focusPoints: [
      ...
      tags: ['Python', 'AWS', 'GPT API', 'Jupyter Notebook', 'LLMs', 'Lambda', 'PyTorch', 'NodeJS', 'S3', 'EC2'],
      dateStart: 'Dec 2022',
      dateEnd: 'Jul 2023',
    },
    {
      ...
      imageUrl: 'ICPC.svg',
      description: 'International Collegiate Programming Contest (ICPC) is a multi-tier, team-based competition among universities from around the world. I was a member of the ICPC college club at my university.',
      focusPoints: [
      ...
      tags: ['ICPC', 'College Club', 'Competitive Programming', 'Algorithms', 'Data Structures', 'Mentoring', 'Teamwork'],
      dateStart: 'Jan 2020',
      dateEnd: 'Sep 2022',
    }
  ], [])
